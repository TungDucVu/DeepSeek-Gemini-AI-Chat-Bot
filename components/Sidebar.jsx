...
const Sidebar = ({expand, setExpand}) => {
    ...
    return (
        <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${expand ? 'p-4 w-64' : 'md:w-20 w-0 max-md:overflow-hidden'}`}>
            <div>
                <div className={`flex ${expand ? "flex-row gap-10" : "flex-col items-center gap-8"}`}>
                    ...
                    <div 
                        ...
                        <Image src={expand ? assets.sidebar_close_icon : assets.sidebar_icon} alt='' className='md:block w-7'/>
                ...
                <button 
                    ...
                    <div className='absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-whte text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none'>
                        New chat 
            ...
            <div>
                <div className={`flex items-center cursor-pointer group relative ${expand ? "gap-1 text-white text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer" : "h-7 w-7 mx-auto hover:bg-gray-500/30 rounded-lg"}`}>
                    <Image className={expand ? "w-5" : "w-8.5 mx-auto"} src={expand ? assets.phone_icon : assets.phone_icon_dull} alt=''/>
